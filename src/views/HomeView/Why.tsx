        ...
        <div style={{
            ...
            <div style={{
                ...
                <Row gutter={[24, 24]} align="middle">
                    ...
                    <Col xs={24} md={10}>
                        <Title className='Why-title' level={2} style={{ color: '#4CAF50', marginBottom: '20px', padding: '5px', backgroundColor: 'white', border: '2px solid black' }}>
                            VÌ SAO THUẬT TOÁN QUAN TRỌNG
                        </Title>
                        <Paragraph className='paragraph-text' style={{ textAlign: 'center', fontSize: '1.2rem' }}>
